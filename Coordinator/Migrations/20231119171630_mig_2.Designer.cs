...
namespace Coordinator.Migrations
{
    ...
    [Migration("20231119171630_mig_2")]
    partial class mig_2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Coordinator.Models.Node", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("af10d17c-4b41-4895-97d2-c47f0991ad8b"),
                            Name = "Order.API"
                        },
                        new
                        {
                            Id = new Guid("f58c277b-dbff-4418-9129-dd0d2d5b92d4"),
                            Name = "Payment.API"
                        },
                        new
                        {
                            Id = new Guid("857250ce-94ab-4204-9826-66d8f0524f94"),
                            Name = "Stock.API"
                        });
                });
